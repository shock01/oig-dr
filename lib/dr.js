(function(root, factory) {
  ...
  DomRenderer.prototype = {
      ...
      while (i--) {
        ...
        if (sourceAttr) {
          if (!targetAttr || sourceAttr.value !== targetAttr.value) {
            target.setAttributeNS(sourceAttr.namespaceURI, sourceAttr.nodeName, sourceAttr.value);
          }
        } else {
          target.removeAttributeNS(targetAttr.namespaceURI, targetAttr.nodeName);
        }
      }
    },
    /**
    ...
    */
    isSameNode: function( /**Element*/ left, /**Element*/ right) {
      return left.nodeType === right.nodeType && left.namespaceURI === right.namespaceURI && left.nodeName === right.nodeName;
    },
    /**
    * @private
    */
  ...
  */
  function parseFromString( /**String*/ source, /**Document*/ targetDocument) /**Node*/ {
    var document = targetDocument.implementation.createDocument('http://www.w3.org/1999/xhtml', 'html', null),
