(function(root, factory) {
  ...
  */
  ...
  DomRenderer.prototype = {
    ...
    replaceElement: function( /**Element*/ newElement, /**Element*/ oldElement) /**Element*/ {
      var targetDocument = this.targetDocument;
      if (newElement.namespaceURI === targetDocument.namespaceURI) {
        return oldElement.parentNode.replaceChild(newElement.cloneNode(true), oldElement);
      } else {
        return oldElement.parentNode.replaceChild(targetDocument.importNode(newElement, true), oldElement);
      }
    },
