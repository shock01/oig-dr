  ...
  DomRenderer.prototype = {
    ...
    */
    replaceChild: function( /**Node*/ newChild, /**Node*/ oldChild) {
      ...
      if (newChild.namespaceURI === targetDocument.namespaceURI) {
        return oldChild.parentNode.replaceChild(newChild.cloneNode(true), oldChild);
      } else {
        return oldChild.parentNode.replaceChild(targetDocument.importNode(newChild, true), oldChild);
      }
    },
    /**
    * @private
